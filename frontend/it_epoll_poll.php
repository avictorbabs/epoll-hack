...
// The Query
$it_epoll_post_query = new WP_Query( $args );
// The Loop

			ob_start();
if ( $it_epoll_post_query->have_posts() ) {

	while ( $it_epoll_post_query->have_posts() ) {
			$it_epoll_post_query->the_post();
		...
		<?php } ?>
				...
				<div class="it_epoll_survey-item-inner it_epoll_card_back" id="it_epoll_otp_confirm_form">
					<form class="it_epoll_survey_confirmation_form" id="it_epoll_otp_confirmation_form" name="it_epoll_otp_confirmation_form" action="" method="post" autocomplete="off">
						<h3 class="it_epoll_voting_confirmation_poll_title" style="font-size: 13px;">Confirm OTP</h3>
