					...
					jQuery.ajax({
								...
								success: function(data){
									...
									if(it_epoll_json.voting_status =='done'){
										...
										jQuery(it_epoll_item).find('#it_epoll_otp_confirm_form').html('<span style="background: #fc7977; align-items: center;display: flex; color:#fff;border-radius:6px; padding:10px;width:100%;margin:0;">You Have Already Participated!</span>');
										jQuery(it_epoll_item).find('#it_epoll_otp_confirm_form').addClass('it_epoll_card_back_visible');
									}
								}
								});	
